...
| `color`       | `color`        | The primary color of the label. Uses the branded CSS variables that are globally available to the application.        | `"black" \| "charcoal" \| "danger" \| "dark-gray" \| "light-gray" \| "medium-gray" \| "primary" \| "secondary" \| "success" \| "white"` | `undefined` |
